	...
	var List = function (_Component) {
	  ...
	  _createClass(List, [{
	    ...
	    value: function searchRender() {
	      ...
	      return showSearch ? _react2.default.createElement('div', { className: 'x-list-search' }, _react2.default.createElement('input', { className: 'x-list-search-input', type: 'text', onChange: this.onSearch })) : undefined;
	    }
	  }, {
	    key: 'renderChildren',
	    ...
	    value: function renderChildren() {
	      ...
	      if (data && data.length > 0) {
	        return data.filter(function (item) {
	          ...
	          return _react2.default.createElement(_Option2.default, { key: index, onSelect: _this2.onSelect.bind(_this2, item, index) }, item[field.text]);
	        });
	      } else {
	        return children;
	      }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { className: cls }, this.searchRender(), _react2.default.createElement('div', { className: 'x-list-options' }, this.renderChildren()), isLoadMore ? _react2.default.createElement('div', null, 'load') : undefined);
	    }
	  }]);
