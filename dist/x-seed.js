	...
	var List = function (_React$PureComponent) {
	  ...
	  _createClass(List, [{
	    ...
	    value: function renderChildren() {
	      ...
	      if (dataSource && dataSource.length > 0) {
	        return dataSource.map(function (item, index) {
	          ...
	          return _react2.default.createElement(_Option2.default, { selected: selected, key: index, value: value, onSelect: _this2.onSelect.bind(_this2, value, item, index) }, item[field.text]);
	        });
	      } else {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { className: cls }, showPager && _react2.default.createElement('i', { className: 'xui icon-last x-scroll-list-page', onClick: this.scroll.bind(this, -1) }), _react2.default.createElement('div', { className: 'x-scroll-list-container', ref: this.containerRef }, _react2.default.createElement('div', { className: 'x-scroll-list-options', ref: this.listRef }, this.renderChildren())), showPager && _react2.default.createElement('i', { className: 'xui icon-next1 x-scroll-list-page', onClick: this.scroll.bind(this, 1) }));
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Option(props) {
	    ...
	    var cls = getCss((_getCss = {}, _defineProperty(_getCss, selected, 'x-scroll-list-option-selected'), _defineProperty(_getCss, disabled, 'x-scroll-list-option-disabled'), _getCss));
	    return _react2.default.createElement('div', { className: 'x-scroll-list-option ' + cls, onClick: onSelect }, children);
	}
